...
; O1-SAME: (ptr [[FVP:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; O1-NEXT:  entry:
; O1-NEXT:    [[VSRC23_I:%.*]] = getelementptr inbounds [[CLASS_FLOATVECPAIR:%.*]], ptr [[FVP]], i64 0, i32 1
; O1-NEXT:    call void @llvm.assume(i1 true) [ "nonnull"(ptr [[VSRC23_I]]) ]
...
; O23-SAME: (ptr [[FVP:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; O23-NEXT:  entry:
; O23-NEXT:    [[VSRC23_I:%.*]] = getelementptr inbounds [[CLASS_FLOATVECPAIR:%.*]], ptr [[FVP]], i64 0, i32 1
; O23-NEXT:    call void @llvm.assume(i1 true) [ "nonnull"(ptr [[VSRC23_I]]) ]
